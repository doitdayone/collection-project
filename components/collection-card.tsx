  ...
  return (
    <>
      <Card
        ...
        className="group bg-white/70 backdrop-blur-sm border-0 rounded-3xl overflow-hidden hover:bg-white/90 hover:scale-105 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl"
      >
